...
namespace AnthonySantosInventoryManagementSystem
{
    public partial class ModifyProductScreen : Form
    {
        public ModifyProductScreen()
        {
            ...
            TextBoxProductID.Text = Inventory.CurrentProduct.ProductID.ToString();
            TextBoxProductName.Text = Inventory.CurrentProduct.Name;
            TextBoxProductInv.Text = Inventory.CurrentProduct.InStock.ToString();
            TextBoxProductPriceCost.Text = Inventory.CurrentProduct.Price.ToString();
            TextBoxProductMax.Text = Inventory.CurrentProduct.Max.ToString();
            TextBoxProductMin.Text = Inventory.CurrentProduct.Min.ToString();

            DataGridViewPartsInProduct.DataSource = Inventory.CurrentProduct.MyAssociatedParts;

            //add product's associated parts to the local associatedParts list
            //for (int j = 0; j < Inventory.CurrentProduct.MyAssociatedParts.Count; j++)
            //{
        ...
        public BindingList<Part> associatedParts = new BindingList<Part>(Inventory.CurrentProduct.MyAssociatedParts);
        ...
        {
            Product p = new Product(associatedParts, Int32.Parse(TextBoxProductID.Text), TextBoxProductName.Text,
                Double.Parse(TextBoxProductPriceCost.Text), Int32.Parse(TextBoxProductInv.Text), Int32.Parse(TextBoxProductMin.Text),
                Int32.Parse(TextBoxProductMax.Text));
